...
def modify():
    """预约图书并更新可借阅图书数量"""
    # 更新图书数量
    sql_update = "UPDATE book SET [数量]=[数量]-1 WHERE ISBN='{}'".format(select_isbn)
